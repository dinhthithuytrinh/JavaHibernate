...
public class ReadStudentDemo {
	...
	public static void main(String[] args) throws ParseException {
		...
		try {
			...
			// Student tempStudent = new Student("Mei", "Kogitsune", "mei@email.com");
			Student tempStudent = new Student("Mei2", "Kogitsune2", "mei2@email.com",
					DateUtils.parseDate("17/09/2000"));
